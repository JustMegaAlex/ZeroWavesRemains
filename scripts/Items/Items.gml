global.non_object_items_list = -1

function InitItems() {
    if ds_exists(global.non_object_items_list, ds_type_list) {
        ds_list_destroy(global.non_object_items_list)
    }
    ...
    global.non_object_items_list = ds_list_create()
    ds_list_add(global.non_object_items_list, global.item_heal)
    ds_list_add(global.non_object_items_list, global.item_ammo)
    ds_list_add(global.non_object_items_list, global.item_coins)
}
